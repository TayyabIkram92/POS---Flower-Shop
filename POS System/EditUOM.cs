...
{
    public partial class EditUOM : Form
    {
        string c;
        SqlConnection con = new SqlConnection();
        public EditUOM(string code)
        {
            InitializeComponent();
        ...
        private void EditUOM_Load(object sender, EventArgs e)
        {
            try
            {
                con.Open();
                SqlCommand cmnd = new SqlCommand("Select * from UOM where UOMCode=@BC", con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("update UOM set UOMName=@n,IsActive=@i where UOMCode=@c", con);
