...
namespace POS_System
{
    public partial class SupplierLedger : Form
    {
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select SupplierCode,VouncherNo,Date as Date_,Narration,0 as Debit,Amount as Credit from CashPaymentVounchers where Date between @a and @b and SupplierCode=@c UNION select SupplierCode, VouncherNo, Date as Date_, Narration, Amount as Debit, 0 as Credit from CashReceiptVounchers where Date between @a and @b and SupplierCode=@c UNION select SupplierCode, 'PUR-'+PurchaseNo as SaleNo, PurchaseDate as Date_, PurchaseDescription, PurchaseAmount as Debit, 0 as Credit from Purchase where PurchaseDate between @a and @b and SupplierCode=@c UNION select SupplierCode, 'PUR-'+PurchaseNo as SaleNo, PurchaseDate as Date_, PurchaseDescription, 0 as Debit, ReceivedAmount as Credit from Purchase where PurchaseDate between @a and @b and SupplierCode=@c order by Date_", con);
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select SupplierUrduName,SupplierBalance,SupplierEnglishName from Suppliers where SupplierCode=@a", con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("select SupplierCode,VouncherNo,Date as Date_,Narration,0 as Debit,Amount as Credit from CashPaymentVounchers where Date between @a and @b and SupplierCode=@c UNION select SupplierCode, VouncherNo, Date as Date_, Narration, Amount as Debit, 0 as Credit from CashReceiptVounchers where Date between @a and @b and SupplierCode=@c UNION select SupplierCode, 'PUR-'+PurchaseNo as SaleNo, PurchaseDate as Date_, PurchaseDescription, PurchaseAmount as Debit, 0 as Credit from Purchase where PurchaseDate between @a and @b and SupplierCode=@c UNION select SupplierCode, 'PUR-'+PurchaseNo as SaleNo, PurchaseDate as Date_, PurchaseDescription, 0 as Debit, ReceivedAmount as Credit from Purchase where PurchaseDate between @a and @b and SupplierCode=@c order by Date_", con);
