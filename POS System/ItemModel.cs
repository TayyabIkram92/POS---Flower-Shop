...
{
    public partial class ItemModel : Form
    {
        ...
        public void Load_Data()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Select * from ItemModelGrid", con);
        ...
        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("Select * from ItemModelGrid where ItemModelName like '%" + textBox6.Text + "%'", con);
                    SqlDataReader rd = cmd.ExecuteReader();
                    while (rd.Read())
                    {
                        dataGridView1.Rows.Add(rd[0], rd[1], rd[2], rd[3], rd[4], rd[5]);
            ...
            else
            {
                ...
                if (MessageBox.Show("Are you sure you want to delete?", "Delete", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    if (code != "")
                    {
                        ...
                        {
                            con.Open();
                            SqlCommand cmd = new SqlCommand("Delete from ItemModel where ItemModelID= @BC", con);
        ...
        private void ItemModel_Load(object sender, EventArgs e)
        {
            Load_Data();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                code = dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[0].Value.ToString();
                EditItemModel E = new EditItemModel(code);
                E.ShowDialog();
            }
        }
    }
